        ...
        <div className="flip-card bg-transparent">
          <div className="flip-card-content bg-transparent">
            ...
            <div className="flip-card-back card">
              <h1 className="bg-transparent text-white p-4 flex justify-center gap-1  capitalize"><BsStars className="bg-transparent text-3xl "/> Winners get opportunity of Internship at startups.</h1>
              <h1 className="bg-transparent text-white p-4 flex justify-center gap-1  capitalize"><BsStars className="bg-transparent text-3xl "/> Selected participants get Mementoes with certificates.</h1>
              <h1 className="bg-transparent text-white p-4 flex justify-center gap-1  capitalize"><BsStars className="bg-transparent text-3xl "/> 100% Certification for ALL eligible participants</h1>
            </div>
          </div>
        </div>
      </div>
